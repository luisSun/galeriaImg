...
def compare_to_folder_image(folder_path, image_name):
    try:
        # Caminho completo da imagem a ser comparada
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Uso: python python.py <caminho_da_pasta> <nome_da_imagem>")
    else:
        folder_path = sys.argv[1]
        image_name = sys.argv[2]
        compare_to_folder_image(folder_path, image_name)
